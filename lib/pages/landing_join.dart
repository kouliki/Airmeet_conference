...
class LandingJoin extends StatefulWidget {
  const LandingJoin({Key? key}) : super(key: key);

  @override
  State<LandingJoin> createState() => _LandingJoinState();
}

class _LandingJoinState extends State<LandingJoin> {
